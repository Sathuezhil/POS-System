...
export const POSProvider = ({ children }) => {
  ...
  // Load products on app start - now empty, components will fetch from API
  useEffect(() => {
    // Products will be loaded by individual components from the API
    // This removes the dummy data completely
  }, []);
